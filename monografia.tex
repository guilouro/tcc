...
\chapter*{Dedicatória\label{cap:dedicatoria}}
    ...
    Não podendo deixar de dedicar o trabalho aos companheiros de classe que viveu comigo os momentos fáceis e os mais complicados de toda a trajetória do curso, sem esquecer os que, de algum lugar, me mandou energia e motivação para a conclusão deste trabalho.
...
\chapter*{Agradecimentos\label{cap:agradecimentos}}
    ...
    Ao meu orientador, professor e companheiros de trabalhor que se envolveram no desenvolvimento deste trabalho e deste projeto. Em especial agradeço a minha família e a minha noiva pela motivação e compreensão em momento dificeis e de ausência de minha parte em resultado à dedicação dada a este projeto.
