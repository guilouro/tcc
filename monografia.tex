...
%titulo do trabalho
\titulo{Framework MVC - Lothus\{PHP\} }
...
\begin{resumo}
    ...
    O \emph{Framework Lothus\{PHP\}} utiliza MVC \emph{(Model, View, Controller)} como padrão de projetos e foi produzido de forma à atender desenvolvedores FrontEnd e BackEnd, trazendo uma estrutura de pasta bem separada para cada etapa do processo de desenvolvimento.
