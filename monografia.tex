...
\begin{thebibliography}{9}
    ...
    \bibitem{cake}Documentação CakePHP Cookbook 2.x. Disponível em: \url{http://book.cakephp.org/2.0/pt/index.html}.
    Acesso em: 02 Fev. Maio. 2015.

    \bibitem{crud}CRUD com JSP. Disponível em: \url{http://www.linhadecodigo.com.br/artigo/2997/crud-com-jsp.aspx}.
    Acesso em: 25 Abril. 2015.

    \bibitem{node}Aplicações web real-time com Node.js. Disponível em: \url{http://nodebr.com/}.
    Acesso em: 26 Abril. 2015.

    \bibitem{rsync}Rsync: Para que serve e como usar. Disponível em: \url{http://gerencievocemesmo.com.br/site/?p=508}.
    Acesso em: 29 Abril. 2015.

    \bibitem{linuxrsync}Viva o Linux: Transferindo arquivos com o rsync. Disponível em: \url{http://www.vivaolinux.com.br/artigo/Transferindo-arquivos-com-o-rsync}.
    Acesso em: 29 Abril. 2015.

    \bibitem{git}Git: Book. Disponível em: \url{http://git-scm.com/book/pt-br/v1}.
    Acesso em: 03 Maio. 2015.

    \bibitem{pdo}PDO - PHP Data Object. Disponível em: \url{http://wiki.locaweb.com/pt-br/PDO_-_PHP_Data_Object}.
    Acesso em: 08 Maio. 2015.

    \bibitem{php}Documentação PHP. Disponível em: \url{http://php.net}.
