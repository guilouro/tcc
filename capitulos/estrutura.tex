...
\end{lstlisting}
        ...
        \subsection{Helpers\label{sub:system-helper}}
            ...
            \begin{itemize}
                ...
                \item\textbf{EmailHelper}: Classe que auxilia o envio de email. Por se tratar de uma classe que extende à \emph{PHPMailer} ela acaba trabalhando como uma facilidadora desta classe que é uma ferramenta avançada para envio de email comum ou autenticado.
